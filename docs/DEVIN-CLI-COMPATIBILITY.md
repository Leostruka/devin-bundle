...
Run installers only against redirected temporary homes during automated compatibility checks. A valid simulation installs all 75 skills and leaves the real user configuration untouched.
