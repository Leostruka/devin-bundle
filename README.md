...
[![Skills](https://img.shields.io/badge/skills-49-blue.svg)](#2-skills)
...
As 49 skills são workflows invocáveis em `skills/<nome>/SKILL.md`. O `manifest.json` mantém nome, origem e finalidade, enquanto o diretório em disco é a fonte descoberta pelo exportador.
...
| [manifest.json](manifest.json) | Inventário e metadados das 49 skills |
