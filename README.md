...
[![Skills](https://img.shields.io/badge/skills-54-blue.svg)](#2-skills)
...
As 54 skills são workflows invocáveis em `skills/<nome>/SKILL.md`. O `manifest.json` mantém nome, origem e finalidade, enquanto o diretório em disco é a fonte descoberta pelo exportador.
...
├── skills/                    # 54 workflows invocáveis
...
| [manifest.json](manifest.json) | Inventário e metadados das 54 skills |
