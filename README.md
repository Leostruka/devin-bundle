...
[![Skills](https://img.shields.io/badge/skills-78-blue.svg)](#2-skills)
...
As 78 skills são workflows invocáveis em `skills/<nome>/SKILL.md`. O `manifest.json` mantém nome, origem e finalidade, enquanto o diretório em disco é a fonte descoberta pelo exportador.
...
| [manifest.json](manifest.json) | Inventário e metadados das 78 skills |
