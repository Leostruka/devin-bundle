...
[![Skills](https://img.shields.io/badge/skills-57-blue.svg)](#2-skills)
...
As 57 skills são workflows invocáveis em `skills/<nome>/SKILL.md`. O `manifest.json` mantém nome, origem e finalidade, enquanto o diretório em disco é a fonte descoberta pelo exportador.
...
| Desktop e dados | `computer-use`, `system-control`, `data-analyst`, `ai-tools`, `brag` | GUI/terminal/browser, análise de dados, ML local, vídeo de lançamento |
...
├── skills/                    # 57 workflows invocáveis
...
| [manifest.json](manifest.json) | Inventário e metadados das 57 skills |
