...
[![Skills](https://img.shields.io/badge/skills-71-blue.svg)](#skills-71)
...
Done. Devin CLI now has 71 skills, 20 rules, 5 subagent profiles, 8 hook events, 15 hook scripts, and 2 manual-run scripts configured.
...
flowchart TB
    subgraph Runtime["Devin CLI Runtime"]
        ...
        SKILLS[skills/<br/>71 skills invoked]
...
├── skills/              # 71 skills (auto-discover, not limited to manifest)
