...
[![Skills](https://img.shields.io/badge/skills-72-blue.svg)](#skills-72)
...
Done. Devin CLI now has 72 skills, 20 rules, 5 subagent profiles, 8 hook events, 15 hook scripts, and 2 manual-run scripts configured.
...
flowchart TB
    subgraph Runtime["Devin CLI Runtime"]
        ...
        SKILLS[skills/<br/>72 skills invoked]
...
├── skills/              # 72 skills (auto-discover, not limited to manifest)
