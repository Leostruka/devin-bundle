...
- Commit: `a3d3649 feat: add context cost controls and destructive-work container guidance`
- Working tree: limpa
- Audit: 32/32 checks, 0 erros, 0 warnings
- Tests: 264 passed (full), 135 passed (held-out)
- Diff check: limpo
- AI signature: nenhuma detectada
- Install sync: `context-window-hygiene`, `cost-optimization`, `docker`, `mcp-context-audit`, `mcp-lazy-enablement` atualizados
